...
Aproveitei a realidade atual para fazer a minha atividadebaseada em fatos que estão ocorrendo. Sobre o oriente.csv, na verdade tive que renomear pois o git não permitia o nome original que era "oriente_medio.csv", esse arquivo foi baixado no kaggle, mas possuía outro nome em inglês, alterei o nome para facilitar a compreensão dos dados.
